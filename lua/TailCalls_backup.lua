--Works but there are a few bugs like the backpack not working correctly
...
Type "map" if you're lost ]]
-- Very rushed lol (might fix never)
...
--This was a practice on tail calls https://www.lua.org/pil/6.3.html 